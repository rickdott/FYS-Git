...
/**
 * Rick 1-300 (- 59-133)/ 419 - 488 (284) Timur 300-419 (119) Matthijs 59-133
 *
...
public class Utilities implements Initializable {
    ...
    private Text labelFaq;
        ...
        /**
         * Loop through the resultset, making a new 'FoundLuggage' Object for
         * every result, adding the attributes of the result to the
        ...
        /**
         * Loop through the resultset, making a new 'LostLuggage' Object for
         * every result, adding the attributes of the result to the
         ...
         * @param solveCase true if you want it to put the luggage in
         * SolvedCases if it is only in foundbagageinventory, false if you dont
