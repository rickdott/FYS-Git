...
/**
 * Contoller for the register found part of the application, you can register a
 * piece of found luggage here
 *
 * @author Tarik Yildirim 500780772 (230 Lines)
 */
    ...
    private void openRegisterThankyou(ActionEvent event) throws SQLException {
        ...
        if (!BagagePrimaryColour.getSelectionModel().isSelected(-1)
            ...
            if (resultSet.next()) {
                ...
                Utilities.infoBox("Flightnumber invalid", "Error", null);
            }
